...
class CheckpointManager:
    ...
    def save_checkpoint(self,
        ...
        # Save to file
        checkpoint_filename = f"checkpoint_{checkpoint_type}_{epoch or 'manual'}_{checkpoint_id[:8]}.pkl"
    ...
    def _determine_checkpoint_type(self, epoch: Optional[int], metrics: Dict[str, float]) -> str:
        ...
        for ckpt_type, ckpts in by_type.items():
            ...
            for ckpt in ckpts_to_remove:
                try:
                    ...
                    print(f"🗑️  Removed old checkpoint: {os.path.basename(ckpt['file_path'])}")
                except OSError:
