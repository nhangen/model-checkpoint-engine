...
class RestAPI(BaseAPI):
    ...
    def __init__(
        self,
        checkpoint_manager: Optional[EnhancedCheckpointManager] = None,
    ...
    def start_server(self, host: str = "0.0.0.0", port: int = 8000) -> bool:
        ...
        try:
            ...
            print(
                "Flask is required for REST API. Install with: pip install flask flask-cors"
            )
            return False
    ...
    def _register_flask_routes(self) -> None:
        ...
        @self._server.route(
            "/api/experiments/<experiment_id>/checkpoints", methods=["GET", "POST"]
        )
        def experiment_checkpoints(experiment_id):
            return self._handle_flask_request(
                f"/api/experiments/{experiment_id}/checkpoints"
            )

        @self._server.route(
            "/api/checkpoints/<checkpoint_id>", methods=["GET", "DELETE"]
        )
        def checkpoint_detail(checkpoint_id):
            return self._handle_flask_request(f"/api/checkpoints/{checkpoint_id}")

        @self._server.route(
            "/api/experiments/<experiment_id>/metrics", methods=["GET", "POST"]
        )
        ...
        @self._server.route(
            "/api/experiments/<experiment_id>/best-models", methods=["GET"]
        )
        def experiment_best_models(experiment_id):
            return self._handle_flask_request(
                f"/api/experiments/{experiment_id}/best-models"
            )
    ...
    def _list_experiments(self, **kwargs) -> APIResponse:
        ...
        try:
            ...
            return APIResponse(
                status=APIStatus.SUCCESS, data={"experiments": experiments}
            )
        except Exception as e:
    ...
    def _get_experiment(self, **kwargs) -> APIResponse:
        ...
        try:
            ...
            return APIResponse(
                status=APIStatus.SUCCESS, data={"experiment": experiment}
            )
        except APIError:
            raise
        except Exception as e:
    ...
    def _list_checkpoints(self, **kwargs) -> APIResponse:
        ...
        try:
            ...
            return APIResponse(
                status=APIStatus.SUCCESS, data={"checkpoints": checkpoints}
            )
        except Exception as e:
    ...
    def _get_checkpoint(self, **kwargs) -> APIResponse:
        ...
        try:
            ...
            return APIResponse(
                status=APIStatus.SUCCESS, data={"checkpoint": checkpoint}
            )
        except APIError:
            raise
        except Exception as e:
    ...
    def _delete_checkpoint(self, **kwargs) -> APIResponse:
        ...
        try:
            ...
            return APIResponse(
                status=APIStatus.SUCCESS, message="Checkpoint deleted successfully"
            )
        except APIError:
            raise
        except Exception as e:
    ...
    def _get_metrics(self, **kwargs) -> APIResponse:
        ...
        try:
            ...
            return APIResponse(status=APIStatus.SUCCESS, data={"metrics": metrics})
        except Exception as e:
    ...
    def _log_metrics(
        ...
        try:
            self.metrics_collector.collect_batch(
                metrics=data["metrics"], step=data.get("step"), epoch=data.get("epoch")
            )

            return APIResponse(
                status=APIStatus.SUCCESS, message="Metrics logged successfully"
            )
        except Exception as e:
    ...
    def _get_best_models(self, **kwargs) -> APIResponse:
        ...
        try:
            ...
            return APIResponse(
                status=APIStatus.SUCCESS, data={"best_models": best_models}
            )
        except Exception as e:
            raise APIError(f"Failed to get best models: {e}", "SELECTION_ERROR")

    def _sync_experiment(
        self, data: Optional[Dict[str, Any]] = None, **kwargs
    ) -> APIResponse:
    ...
    def _api_info(self, **kwargs) -> APIResponse:
        ...
        return APIResponse(status=APIStatus.SUCCESS, data=info)
