...
from model_checkpoint.hooks.hook_manager import HookEvent, HookManager, HookPriority
...
def test_basic_hook_functionality():
    ...
    result = manager.fire_hook(
        HookEvent.BEFORE_CHECKPOINT_SAVE, test_data="hello_world"
    )
...
def main():
    ...
    try:
        ...
        print(
            "   ✅ Decorators for easy hook registration (@hook_handler, @conditional_hook)"
        )
